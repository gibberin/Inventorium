...
namespace Inventorium.Data.Migrations
{
    ...
    [Migration("20191122171944_Added_Bin_Description")]
    partial class Added_Bin_Description
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoriumLib.Bin", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("InventoriumLib.Rack", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("InventoriumLib.Bin", b =>
                {
                    b.HasOne("InventoriumLib.Rack", "Rack")
                        .WithMany()
            ...
            modelBuilder.Entity("InventoriumLib.Item", b =>
                {
                    ...
                    b.HasOne("InventoriumLib.Bin", "Bin")
                        .WithMany()
                        .HasForeignKey("BinID");
                });
